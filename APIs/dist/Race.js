...
exports.SortByPosition = exports.GetSchedules = exports.GetRace = exports.GetLastRace = void 0;
...
function GetLastRace() {
    ...
    return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    URL = Config.APIs + "/current/last/results.json";
...
exports.GetLastRace = GetLastRace;
function GetRace(Year, Round) {
    var _this = this;
    return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
        var URL, APIresponse, Res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    URL = Config.APIs + "/" + Year + "/" + Round + "/results.json";
                    return [4 /*yield*/, axios_1.default.get(URL)];
                case 1:
                    APIresponse = _a.sent();
                    Res = {};
